...
def compute_portvals(  		  	   		  		 		  		  		    	 		 		   		 		  
    ...
    # print("Data types for df_prices:\n", df_prices.dtypes)
    # print("Data types for df_trades:\n", df_trades.dtypes)
    # print("Data types for df_values:\n", df_holdings.dtypes)
    # print("Data types for df_holdings:\n", df_values.dtypes)
    # print("Data types for df_port_val:\n", df_port_val.dtypes)
    # print(df_port_val)
    print(df_port_val)
    return df_port_val
