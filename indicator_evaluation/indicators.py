...
def plot_momentum(symbol="JPM", sd="2008-01-01", ed="2009-12-31", lb=20):
    # Fetch the prices
...
def plot_bollinger_bands(symbol="JPM", sd="2008-01-01", ed="2009-12-31", window=20):
    dates = pd.date_range(sd, ed)
    prices = get_data([symbol], dates)[symbol]
...
def plot_rsi(symbol="JPM", sd="2008-01-01", ed="2009-12-31", window=14):
    dates = pd.date_range(sd, ed)
    prices = get_data([symbol], dates)[symbol]
...
def plot_macd(symbol="JPM", sd="2008-01-01", ed="2009-12-31"):
    dates = pd.date_range(sd, ed)
    prices = get_data([symbol], dates)[symbol]
...
def plot_cci(symbol="JPM", sd="2008-01-01", ed="2009-12-31", window=20):
    dates = pd.date_range(sd, ed)
    prices = get_data([symbol], dates)[symbol]
